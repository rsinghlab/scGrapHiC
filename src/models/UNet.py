...
class ResidualBlock(pl.LightningModule):
    ...
    def __init__(self, in_channels: int, out_channels: int, n_groups: int = 8, dropout: float = 0.1):
        """
    ...
    def forward(self, x: torch.Tensor):
        ...
        * `t` has shape `[batch_size, time_channels]`
        ...
        #print('first conv', h.shape)
        # Second convolution layer
        h = self.conv2(self.dropout(self.act2(self.norm2(h))))
        #print('second conv', h.shape)
...
class AttentionBlock(pl.LightningModule):
    ...
    def __init__(self, n_channels: int, n_heads: int = 1, d_k: int = -1, n_groups: int = 32):
        """
...
class UnetDecoder(pl.LightningModule):
    def __init__(self, PARAMETERS, act=nn.Sigmoid()):
        super(UnetDecoder, self).__init__()
        self.unet = UNet(
            PARAMETERS['num_channels'], 
            PARAMETERS['encoder_hidden_embedding_size']
        )
        self.act = act
